...
import { getAcsesories } from '../../../redux/features/acsesoriesSlice'
...
const Category3 = ({ slugDescription }) => {
  const { acsesories, loading } = useSelector((state) => state.acsesories)
